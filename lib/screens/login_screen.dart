...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      final userExists = await _localStorage.userExists(_emailController.text.trim());
      ...
      // Verify password
      final isValid = await _localStorage.verifyLogin(
      ...
      // Login successful - just mark as logged in (credentials already stored)
      await _localStorage.saveLoginCredentials(
        studentId: _localStorage.getStudentId(),
        studentName: _localStorage.getStudentName(),
        email: _localStorage.getEmail(),
      );
